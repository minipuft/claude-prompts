...
import type { GateGuide, GateActivationContext, GateSelectionContext, GateSelectionResult, GateGuideEntry, GateRegistryStats } from './types/index.js';
 ...
 * ```
 */
export declare class GateManager extends BaseResourceHandler<GateGuide, GateGuideEntry, GateManagerConfig, GateRegistryStats> implements IGateManager {
    private registry;
