...
export declare const GatePassCriteriaSchema: z.ZodObject<{
    ...
    type: z.ZodEnum<["content_check", "llm_self_check", "pattern_check", "methodology_compliance", "shell_verify"]>;
    ...
    shell_timeout: z.ZodOptional<z.ZodNumber>;
    /** Working directory for shell command execution */
    shell_working_dir: z.ZodOptional<z.ZodString>;
    /** Additional environment variables for shell command */
    shell_env: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodString>>;
    /** Maximum verification attempts before escalation (default: 5) */
    shell_max_attempts: z.ZodOptional<z.ZodNumber>;
    /** Preset for shell verification (:fast, :full, :extended) */
    shell_preset: z.ZodOptional<z.ZodEnum<["fast", "full", "extended"]>>;
