...
import type { MetricsCollector, McpToolRequest, ToolResponse } from '../../../shared/types/index.js';
/**
...
export declare class PromptExecutionPipeline {
    ...
    gateReviewStage: PipelineStage, formattingStage: PipelineStage, postFormattingStage: PipelineStage, logger: Logger, metricsProvider?: () => MetricsCollector | undefined);
    /**
