...
export declare class StepExecutionStage extends BasePipelineStage {
    ...
    constructor(chainOperatorExecutor: ChainOperatorExecutor, chainSessionManager: ChainSessionService, logger: Logger, referenceResolver?: PromptReferenceResolver | undefined, scriptReferenceResolver?: ScriptReferenceResolverPort | undefined);
