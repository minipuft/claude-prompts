...
import type { ScriptExecutorPort, ToolDetectionServicePort } from '../../../shared/types/index.js';
...
export declare class PromptReferenceResolver {
    ...
    constructor(logger: Logger, prompts: ConvertedPrompt[], toolDetectionService?: ToolDetectionServicePort | undefined, scriptExecutor?: ScriptExecutorPort | undefined, options?: ReferenceResolutionOptions);
    /**
