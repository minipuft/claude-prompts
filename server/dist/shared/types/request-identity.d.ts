import type { ClientFamily, DelegationProfile, IdentityLaunchDefaults, IdentityPolicyMode } from './core-config.js';
/**
...
export type RequestClientProfileSource = 'launch-default' | 'trusted-request' | 'request-hint' | 'client-info' | 'default';
/**
