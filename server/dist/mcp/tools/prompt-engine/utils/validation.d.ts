...
export declare class EngineValidator {
     ...
     */
    validateWithGates(convertedPrompt: ConvertedPrompt, _promptArgs: Record<string, any>, suggestedGates?: string[], processedContent?: string): Promise<GateValidationResult>;
}
