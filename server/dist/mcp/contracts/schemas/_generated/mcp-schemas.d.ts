 ...
 * Generated from contract version 1
 */
export declare const skillsSyncSchema: z.ZodObject<{
    ...
    action: z.ZodEnum<["status", "export", "sync", "diff", "pull", "clone"]>;
    ...
    resource_type: z.ZodOptional<z.ZodEnum<["prompt", "gate", "methodology", "style"]>>;
