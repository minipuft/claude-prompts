 ...
 * ```
 */
export { ResourceChangeTracker, createResourceChangeTracker, type ChangeSource, type ChangeOperation, type TrackedResourceType, type ResourceChangeEntry, type LogChangeParams, type GetChangesParams, type ResourceChangeTrackerConfig, } from './resource-change-tracker.js';
