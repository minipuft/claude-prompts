 ...
 */
export type ResourceAction = 'create' | 'update' | 'delete' | 'list' | 'inspect' | 'reload' | 'analyze_type' | 'analyze_gates' | 'guide' | 'switch' | 'history' | 'rollback' | 'compare' | 'clear';
/**
...
export declare const CHECKPOINT_ONLY_ACTIONS: ResourceAction[];
