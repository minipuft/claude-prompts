import type { PromptResourceMetadataData, ToolMetadata } from './types.js';
declare const promptResourceActions: readonly [{
    readonly id: "create";
...
export declare const promptResourceMetadata: ToolMetadata<PromptResourceMetadataData>;
export {};
