...
import type { ChainState, PendingGateReview, PendingShellVerificationSnapshot, StepMetadata } from './chain-execution.js';
...
export interface ChainSessionService {
    createSession(sessionId: string, chainId: string, totalSteps: number, originalArgs?: Record<string, unknown>, options?: StateStoreOptions & {
        blueprint?: SessionBlueprint;
    ...
    onSessionCleared(callback: (sessionId: string, session: ChainSession) => void | Promise<void>): void;
