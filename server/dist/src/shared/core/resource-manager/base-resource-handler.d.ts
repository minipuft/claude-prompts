 ...
 */
export declare abstract class BaseResourceHandler<TResource, TEntry = unknown, TConfig extends BaseResourceHandlerConfig = BaseResourceHandlerConfig, TStats = ResourceManagerStats> {
