...
import type { ConfigManager, Logger, HotReloadEventType, FileChangeOperation, HotReloadEvent } from '../../shared/types/index.js';
 ...
 */
export declare class HotReloadObserver {
 ...
 */
export declare function createHotReloadObserver(logger: Logger, config?: Partial<HotReloadConfig>, configManager?: ConfigManager): HotReloadObserver;
