...
import type { ScriptExecutorPort, LoadedScriptTool } from '../../../shared/types/index.js';
/**
...
export declare class ScriptReferenceResolver {
    ...
    constructor(logger: Logger, scriptLoader: ScriptLoader, scriptExecutor: ScriptExecutorPort, options?: ScriptResolutionOptions);
    /**
