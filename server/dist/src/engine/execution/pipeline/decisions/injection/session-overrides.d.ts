 ...
 */
export declare class SessionOverrideResolver {
 ...
 */
export declare function initSessionOverrideResolver(logger: Logger): SessionOverrideResolver;
/**
 * Get the current session override manager.
 * Throws if not initialized.
 */
export declare function getSessionOverrideResolver(): SessionOverrideResolver;
/**
 * Check if the session override manager is initialized.
 */
export declare function isSessionOverrideResolverInitialized(): boolean;
/**
 * Reset the session override manager (for testing).
 */
export declare function resetSessionOverrideResolver(): void;
