...
import type { ExecutionModeServicePort, ScriptExecutorPort, ToolDetectionServicePort } from '../../../../shared/types/index.js';
...
export declare class ScriptExecutionStage extends BasePipelineStage {
    ...
    constructor(scriptExecutor: ScriptExecutorPort, toolDetectionService: ToolDetectionServicePort, executionModeService: ExecutionModeServicePort, logger: Logger);
 ...
 */
export declare function createScriptExecutionStage(scriptExecutor: ScriptExecutorPort, toolDetectionService: ToolDetectionServicePort, executionModeService: ExecutionModeServicePort, logger: Logger): ScriptExecutionStage;
