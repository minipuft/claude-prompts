...
import type { MetricsCollector, McpToolRequest, ToolResponse, HookRegistryPort } from '../../../shared/types/index.js';
/**
...
export declare class PromptExecutionPipeline {
    ...
    private readonly identityResolutionStage;
    ...
    private readonly phaseGuardVerificationStage;
    ...
    constructor(requestStage: PipelineStage, dependencyStage: PipelineStage, lifecycleStage: PipelineStage, identityResolutionStage: PipelineStage, parsingStage: PipelineStage, inlineGateStage: PipelineStage, operatorValidationStage: PipelineStage, planningStage: PipelineStage, scriptExecutionStage: PipelineStage | null, // 04b - Script tool execution
    ...
    executionStage: PipelineStage, phaseGuardVerificationStage: PipelineStage | null, // 09b - Phase guard verification
    gateReviewStage: PipelineStage, formattingStage: PipelineStage, postFormattingStage: PipelineStage, logger: Logger, metricsProvider?: () => MetricsCollector | undefined, hookRegistry?: HookRegistryPort);
    /**
    ...
    private emitBeforeStage;
    private emitAfterStage;
    private emitStageError;
