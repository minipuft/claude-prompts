...
export declare class FrameworkSemanticIntegration {
    ...
    constructor(frameworkManager: FrameworkManager, frameworkStateStore: FrameworkStateStore, semanticAnalyzer: ContentAnalyzerPort, logger: Logger, config?: Partial<FrameworkSwitchingConfig>);
    /**
 ...
 */
export declare function createFrameworkSemanticIntegration(frameworkManager: FrameworkManager, frameworkStateStore: FrameworkStateStore, logger: Logger, semanticAnalyzer: ContentAnalyzerPort, config?: Partial<FrameworkSwitchingConfig>): Promise<FrameworkSemanticIntegration>;
