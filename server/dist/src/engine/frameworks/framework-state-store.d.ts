 ...
 */
export declare class FrameworkStateStore extends EventEmitter {
    private logger;
    ...
    private stateStore?;
    constructor(logger: Logger, serverRoot: string, injectedStore?: SqliteStateStore<PersistedFrameworkState>);
 ...
 */
export declare function createFrameworkStateStore(logger: Logger, serverRoot: string, stateStore?: SqliteStateStore<PersistedFrameworkState>): Promise<FrameworkStateStore>;
