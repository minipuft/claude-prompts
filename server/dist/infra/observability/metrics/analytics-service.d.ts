...
import { type MetricsCollector, type ExecutionData, type GateValidationData, type GateUsageMetric, type FrameworkSwitchData, type ExecutionStats, type SystemMetrics, type FrameworkUsage, type AnalyticsQueryOptions, type AnalyticsSummary, type PipelineStageMetric, type CommandExecutionMetric } from './types.js';
import { Logger } from '../../logging/index.js';
/**
 * Centralized Metrics Collector
 */
export declare class InMemoryMetricsCollector extends EventEmitter implements MetricsCollector {
    private logger;
    private startTime;
 ...
 */
export declare function createMetricsCollector(logger: Logger): InMemoryMetricsCollector;
