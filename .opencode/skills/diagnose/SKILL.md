...
metadata:
  ...
  source-hash: 7940c52d2ba0efda4eb7cf3b49fe06f5f50fe67e61282b542439dc7db3870b17
  category: general
---
...
- **scope**: Specific files, directories, or areas to analyze (e.g., 'src/auth/**', 'performance issues', 'security')
- **focus**: Specific diagnostic focus (e.g., 'security', 'performance', 'architecture', 'type errors')
- **symptoms**: Reported symptoms or problems (e.g., 'slow build times', 'memory leaks', 'failing tests')
